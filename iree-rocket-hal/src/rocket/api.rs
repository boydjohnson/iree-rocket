...
pub const DRM_ROCKET_CREATE_BO: u32 = 0;
pub const DRM_ROCKET_SUBMIT: u32 = 1;
pub const DRM_ROCKET_PREP_BO: u32 = 2;
pub const DRM_ROCKET_FINI_BO: u32 = 3;
...
pub use self::{drm_map_flags as drm_map_flags_t, drm_map_type as drm_map_type_t};
...
#[doc = " struct drm_rocket_create_bo - ioctl argument for creating Rocket BOs.\n"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct drm_rocket_create_bo {
    #[doc = " Input: Size of the requested BO."]
    pub size: __u32,
    #[doc = " Output: GEM handle for the BO."]
    pub handle: __u32,
    #[doc = " Output: DMA address for the BO in the NPU address space.  This address\n is private to the DRM fd and is valid for the lifetime of the GEM\n handle."]
    pub dma_address: __u64,
    #[doc = " Output: Offset into the drm node to use for subsequent mmap call."]
    pub offset: __u64,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of drm_rocket_create_bo"][::std::mem::size_of::<drm_rocket_create_bo>() - 24usize];
    ["Alignment of drm_rocket_create_bo"][::std::mem::align_of::<drm_rocket_create_bo>() - 8usize];
    ["Offset of field: drm_rocket_create_bo::size"]
        [::std::mem::offset_of!(drm_rocket_create_bo, size) - 0usize];
    ["Offset of field: drm_rocket_create_bo::handle"]
        [::std::mem::offset_of!(drm_rocket_create_bo, handle) - 4usize];
    ["Offset of field: drm_rocket_create_bo::dma_address"]
        [::std::mem::offset_of!(drm_rocket_create_bo, dma_address) - 8usize];
    ["Offset of field: drm_rocket_create_bo::offset"]
        [::std::mem::offset_of!(drm_rocket_create_bo, offset) - 16usize];
};
#[doc = " struct drm_rocket_prep_bo - ioctl argument for starting CPU ownership of the BO.\n\n Takes care of waiting for any NPU jobs that might still use the NPU and performs cache\n synchronization."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct drm_rocket_prep_bo {
    #[doc = " Input: GEM handle of the buffer object."]
    pub handle: __u32,
    #[doc = " Reserved, must be zero."]
    pub reserved: __u32,
    #[doc = " Input: Amount of time to wait for NPU jobs."]
    pub timeout_ns: __s64,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of drm_rocket_prep_bo"][::std::mem::size_of::<drm_rocket_prep_bo>() - 16usize];
    ["Alignment of drm_rocket_prep_bo"][::std::mem::align_of::<drm_rocket_prep_bo>() - 8usize];
    ["Offset of field: drm_rocket_prep_bo::handle"]
        [::std::mem::offset_of!(drm_rocket_prep_bo, handle) - 0usize];
    ["Offset of field: drm_rocket_prep_bo::reserved"]
        [::std::mem::offset_of!(drm_rocket_prep_bo, reserved) - 4usize];
    ["Offset of field: drm_rocket_prep_bo::timeout_ns"]
        [::std::mem::offset_of!(drm_rocket_prep_bo, timeout_ns) - 8usize];
};
#[doc = " struct drm_rocket_fini_bo - ioctl argument for finishing CPU ownership of the BO.\n\n Synchronize caches for NPU access."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of drm_rocket_fini_bo"][::std::mem::size_of::<drm_rocket_fini_bo>() - 8usize];
    ["Alignment of drm_rocket_fini_bo"][::std::mem::align_of::<drm_rocket_fini_bo>() - 4usize];
    ["Offset of field: drm_rocket_fini_bo::handle"]
        [::std::mem::offset_of!(drm_rocket_fini_bo, handle) - 0usize];
    ["Offset of field: drm_rocket_fini_bo::reserved"]
        [::std::mem::offset_of!(drm_rocket_fini_bo, reserved) - 4usize];
};
#[doc = " struct drm_rocket_task - A task to be run on the NPU\n\n A task is the smallest unit of work that can be run on the NPU."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct drm_rocket_task {
    #[doc = " Input: DMA address to NPU mapping of register command buffer"]
    pub regcmd: __u32,
    #[doc = " Input: Number of commands in the register command buffer"]
    pub regcmd_count: __u32,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of drm_rocket_task"][::std::mem::size_of::<drm_rocket_task>() - 8usize];
    ["Alignment of drm_rocket_task"][::std::mem::align_of::<drm_rocket_task>() - 4usize];
    ["Offset of field: drm_rocket_task::regcmd"]
        [::std::mem::offset_of!(drm_rocket_task, regcmd) - 0usize];
    ["Offset of field: drm_rocket_task::regcmd_count"]
        [::std::mem::offset_of!(drm_rocket_task, regcmd_count) - 4usize];
};
#[doc = " struct drm_rocket_job - A job to be run on the NPU\n\n The kernel will schedule the execution of this job taking into account its\n dependencies with other jobs. All tasks in the same job will be executed\n sequentially on the same core, to benefit from memory residency in SRAM."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct drm_rocket_job {
    #[doc = " Input: Pointer to an array of struct drm_rocket_task."]
    pub tasks: __u64,
    #[doc = " Input: Pointer to a u32 array of the BOs that are read by the job."]
    pub in_bo_handles: __u64,
    #[doc = " Input: Pointer to a u32 array of the BOs that are written to by the job."]
    pub out_bo_handles: __u64,
    #[doc = " Input: Number of tasks passed in."]
    pub task_count: __u32,
    #[doc = " Input: Size in bytes of the structs in the @tasks field."]
    pub task_struct_size: __u32,
    #[doc = " Input: Number of input BO handles passed in (size is that times 4)."]
    pub in_bo_handle_count: __u32,
    #[doc = " Input: Number of output BO handles passed in (size is that times 4)."]
    pub out_bo_handle_count: __u32,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of drm_rocket_job"][::std::mem::size_of::<drm_rocket_job>() - 40usize];
    ["Alignment of drm_rocket_job"][::std::mem::align_of::<drm_rocket_job>() - 8usize];
    ["Offset of field: drm_rocket_job::tasks"]
        [::std::mem::offset_of!(drm_rocket_job, tasks) - 0usize];
    ["Offset of field: drm_rocket_job::in_bo_handles"]
        [::std::mem::offset_of!(drm_rocket_job, in_bo_handles) - 8usize];
    ["Offset of field: drm_rocket_job::out_bo_handles"]
        [::std::mem::offset_of!(drm_rocket_job, out_bo_handles) - 16usize];
    ["Offset of field: drm_rocket_job::task_count"]
        [::std::mem::offset_of!(drm_rocket_job, task_count) - 24usize];
    ["Offset of field: drm_rocket_job::task_struct_size"]
        [::std::mem::offset_of!(drm_rocket_job, task_struct_size) - 28usize];
    ["Offset of field: drm_rocket_job::in_bo_handle_count"]
        [::std::mem::offset_of!(drm_rocket_job, in_bo_handle_count) - 32usize];
    ["Offset of field: drm_rocket_job::out_bo_handle_count"]
        [::std::mem::offset_of!(drm_rocket_job, out_bo_handle_count) - 36usize];
};
#[doc = " struct drm_rocket_submit - ioctl argument for submitting commands to the NPU.\n\n The kernel will schedule the execution of these jobs in dependency order."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct drm_rocket_submit {
    #[doc = " Input: Pointer to an array of struct drm_rocket_job."]
    pub jobs: __u64,
    #[doc = " Input: Number of jobs passed in."]
    pub job_count: __u32,
    #[doc = " Input: Size in bytes of the structs in the @jobs field."]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of drm_rocket_submit"][::std::mem::size_of::<drm_rocket_submit>() - 24usize];
    ["Alignment of drm_rocket_submit"][::std::mem::align_of::<drm_rocket_submit>() - 8usize];
    ["Offset of field: drm_rocket_submit::jobs"]
        [::std::mem::offset_of!(drm_rocket_submit, jobs) - 0usize];
    ["Offset of field: drm_rocket_submit::job_count"]
        [::std::mem::offset_of!(drm_rocket_submit, job_count) - 8usize];
    ["Offset of field: drm_rocket_submit::job_struct_size"]
        [::std::mem::offset_of!(drm_rocket_submit, job_struct_size) - 12usize];
    ["Offset of field: drm_rocket_submit::reserved"]
        [::std::mem::offset_of!(drm_rocket_submit, reserved) - 16usize];
};
